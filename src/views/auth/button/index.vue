<template>
  <div class="card content-box">
    ...
    <el-row class="mb20">
      <el-button type="primary" :icon="Plus" v-if="BUTTONS.add">新增</el-button>
    ...
    <el-row class="mb20">
      <el-button type="primary" :icon="Plus" v-auth="'add'">新增</el-button>
    ...
    <el-row>
      <el-button type="primary" :icon="Plus" v-auth="['add', 'edit', 'delete', 'import', 'export']">新增</el-button>
...
import { Plus, Delete, EditPen, Download, Upload, Document } from "@element-plus/icons-vue";
