  ...
  <div class="table-box">
    <ProTable ref="proTable" title="杭州工单" :columns="columns" :request-api="getTableList" :init-param="initParam">
      ...
      <template #tableHeader>
        <el-button type="primary" @click="operatorOrder()" v-if="BUTTONS.add" :icon="Plus">新增工单</el-button>
...
<script setup lang="tsx" name="XinWork">
import { getSalesList, delSalesOrder, orderTemplate, orderUpload, orderExport } from "@/api/modules/ticket";
import { Plus, Delete, EditPen, Download, Upload, View, Document } from "@element-plus/icons-vue";
