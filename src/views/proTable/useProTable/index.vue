  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader="scope">
        <el-button type="primary" :icon="Plus" @click="openDrawer('新增')" v-auth="'add'">新增</el-button>
        <el-button type="primary" :icon="Upload" plain @click="batchAdd" v-auth="'batchAdd'">批量添加</el-button>
...
import { Plus, Delete, EditPen, Download, Upload, View, Refresh } from "@element-plus/icons-vue";
import {
  getUserList,
  deleteUser,
  editUser,
