  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader="scope">
        <el-button type="primary" :icon="Plus" @click="proTable?.element?.toggleAllSelection">全选 / 全不选</el-button>
...
import { Plus, Pointer, Delete, Refresh } from "@element-plus/icons-vue";
